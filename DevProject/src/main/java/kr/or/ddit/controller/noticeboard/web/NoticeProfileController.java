...
public class NoticeProfileController {
	...
	public String noticeProfile(HttpServletRequest req, RedirectAttributes ra, Model model) {
		...
		if(sessionMember == null) {
			ra.addFlashAttribute("message", "로그인 후 이용가능합니다요");
	...
	public String noticeProfileUpload(
			...
			DDITMemberVO member, RedirectAttributes ra, Model model
			) {
		String goPage="";
		ServiceResult result = noticeService.profileUpdate(req,member);
